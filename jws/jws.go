...
func Decode(payload string, claimSet interface{}) error {
	if reflect.ValueOf(claimSet).Kind() != reflect.Ptr {
		return fmt.Errorf("claim set should be a pointer")
	}
	...
	return json.NewDecoder(bytes.NewBuffer(decoded)).Decode(claimSet)
}
